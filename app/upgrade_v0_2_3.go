...
import (
	...
	"github.com/Galactica-corp/galactica/app/upgrades/v0_2_3"
	tmproto "github.com/cometbft/cometbft/proto/tendermint/types"
	sdk "github.com/cosmos/cosmos-sdk/types"
	"github.com/cosmos/cosmos-sdk/types/module"
)

const PlanUpgradeName = "0.2.3"

func (app *App) applyUpgrade_v0_2_3() {
	planName := v0_2_3.UpgradeName

	logger := app.Logger().With("upgrade", planName)

	app.UpgradeKeeper.SetUpgradeHandler(planName, app.upgradeHandler_v0_2_3())
	...
	if doneHeight != 0 {
		logger.Info("upgrade v0.2.3 done")
		return
	}

	logger.Info("Schedule upgrade plan", "name", planName)

	if err := app.UpgradeKeeper.ScheduleUpgrade(ctx, v0_2_3.Plan); err != nil {
		panic(err)
	}
}

func (app *App) upgradeHandler_v0_2_3() func(ctx context.Context, _ upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
