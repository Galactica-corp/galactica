...
const (
	Query_Params_FullMethodName       = "/galactica.epochs.Query/Params"
	Query_EpochInfos_FullMethodName   = "/galactica.epochs.Query/EpochInfos"
	Query_CurrentEpoch_FullMethodName = "/galactica.epochs.Query/CurrentEpoch"
)
